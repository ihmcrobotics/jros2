 ...
 */
void* fastddsjava_create_participant(std::string xml, std::string profile_name) {
 ...
 */
void* fastddsjava_create_datareader(void* subscriber_, void* topic_, std::string profile_name) {
