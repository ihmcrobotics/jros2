...
// #include <fastdds/rtps/common/GuidUtils.hpp>
...
public static native @Cast("uint32_t") int fastddsjava_datareader_read_next_sample(Pointer reader_, Pointer data, fastddsjava_SampleInfo info);

public static native @Cast("uint32_t") int fastddsjava_datareader_take_next_custom(Pointer reader_, Pointer data, fastddsjava_SampleInfo info);
...
public static native void fastddsjava_subscription_matched_status_last_publication_guid(
        @Const @ByRef SubscriptionMatchedStatus status, @Cast("uint8_t*") BytePointer guid_out);
public static native void fastddsjava_subscription_matched_status_last_publication_guid(
        @Const @ByRef SubscriptionMatchedStatus status, @Cast("uint8_t*") ByteBuffer guid_out);
public static native void fastddsjava_subscription_matched_status_last_publication_guid(
        @Const @ByRef SubscriptionMatchedStatus status, @Cast("uint8_t*") byte[] guid_out);
...
// #include <fastdds/dds/common/InstanceHandle.hpp>
// Targeting fastddsjava_SampleInfo.java
