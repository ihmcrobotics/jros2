...
/**
<p>Source (stereo_msgs/DisparityImage):
<pre>{@code
...
public class DisparityImage implements ROS2Message<DisparityImage>
{
   ...
   */
   ...
   /**
      ...
      that they are verged). That is: d = x_l - x_r - (cx_l - cx_r)
   */
   private final sensor_msgs.Image image_;
   /**
      Stereo geometry. For disparity d, the depth from the camera is Z = fT/d.
   */
   ...
   /**
      Subwindow of (potentially) valid disparity values.
   */
   private final sensor_msgs.RegionOfInterest valid_window_;
   /**
      The range of disparities searched.
      In the disparity image, any disparity less than min_disparity is invalid.
      The disparity search range defines the horopter, or 3D volume that the
   ...
   */
   ...
   public DisparityImage()
   {
      ...
      image_ = new sensor_msgs.Image();
      valid_window_ = new sensor_msgs.RegionOfInterest();
   ...
   public sensor_msgs.RegionOfInterest getValidWindow()
   {
