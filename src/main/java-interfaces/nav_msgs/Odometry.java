...
public class Odometry implements ROS2Message<Odometry>
{
   ...
   */
   ...
   /**
      Estimated linear and angular velocity relative to child_frame_id.
   */
   private final geometry_msgs.TwistWithCovariance twist_;
   ...
   public Odometry()
   {
      ...
      twist_ = new geometry_msgs.TwistWithCovariance();
   ...
   public geometry_msgs.TwistWithCovariance getTwist()
   {
      return twist_;
   }
