...
public class Marker implements ROS2Message<Marker>
{
   ...
   */
   ...
   /**
      Scale of the object; 1,1,1 means default (usually 1 meter square).
   */
   private final geometry_msgs.Vector3 scale_;
   /**
      Color of the object; in the range: [0.0-1.0]
   */
   private final std_msgs.ColorRGBA color_;
   /**
      How long the object should last before being automatically deleted.
      0 indicates forever.
   */
   ...
   */
   ...
   /**
      ...
      NOTE: alpha is not yet used
   */
   private final IDLObjectSequence<std_msgs.ColorRGBA> colors_;
   /**
      Texture resource is a special URI that can either reference a texture file in
      a format acceptable to (resource retriever)[https://index.ros.org/p/resource_retriever/]
      or an embedded texture via a string matching the format:
   ...
   */
   ...
   /**
      ...
      This will be used iff texture_resource is set to embedded.
   */
   private final sensor_msgs.CompressedImage texture_;
   /**
      Location of each vertex within the texture; in the range: [0.0-1.0]
   */
   private final IDLObjectSequence<visualization_msgs.UVCoordinate> uv_coordinates_;
   /**
      Only used for text markers
   */
   ...
   */
   ...
   private final visualization_msgs.MeshFile mesh_file_;
   ...
   public Marker()
   {
      ...
      scale_ = new geometry_msgs.Vector3();
      color_ = new std_msgs.ColorRGBA();
      ...
      colors_ = new IDLObjectSequence<std_msgs.ColorRGBA>(std_msgs.ColorRGBA.class);
      texture_resource_ = new StringBuilder();
      texture_ = new sensor_msgs.CompressedImage();
      uv_coordinates_ = new IDLObjectSequence<visualization_msgs.UVCoordinate>(visualization_msgs.UVCoordinate.class);
      text_ = new StringBuilder();
      mesh_resource_ = new StringBuilder();
      mesh_file_ = new visualization_msgs.MeshFile();
      mesh_use_embedded_materials_ = (boolean) false;
   ...
   public int calculateSizeBytes(int currentAlignment)
   {
      ...
      currentAlignment += 4 + CDRBuffer.alignment(currentAlignment, 4) + (2 * (texture_resource_.length() + 1)); // texture_resource_
      ...
      currentAlignment += 4 + CDRBuffer.alignment(currentAlignment, 4) + (2 * (text_.length() + 1)); // text_
      currentAlignment += 4 + CDRBuffer.alignment(currentAlignment, 4) + (2 * (mesh_resource_.length() + 1)); // mesh_resource_
   ...
   public geometry_msgs.Vector3 getScale()
   {
      return scale_;
   }

   public std_msgs.ColorRGBA getColor()
   {
      return color_;
   }
   ...
   public IDLObjectSequence<std_msgs.ColorRGBA> getColors()
   {
      return colors_;
   }
   ...
   public IDLObjectSequence<visualization_msgs.UVCoordinate> getUvCoordinates()
   {
