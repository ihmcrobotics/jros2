 ...
 *
 * Original .msg file content (visualization_msgs/InteractiveMarkerUpdate.msg):
...
public class InteractiveMarkerUpdate implements ROS2Message<InteractiveMarkerUpdate>
{
   ...
   */
   ...
   public int calculateSizeBytes(int currentAlignment)
   {
      ...
      currentAlignment += (1 * server_id_.length()) + CDRBuffer.alignment(currentAlignment, (1 * server_id_.length())); // server_id_
