...
public class Marker implements ROS2Message<Marker>
{
   ...
   */
   ...
   public int calculateSizeBytes(int currentAlignment)
   {
      ...
      currentAlignment += 4 + CDRBuffer.alignment(currentAlignment, 4) + ns_.length() + 1; // ns_
      ...
      currentAlignment += 4 + CDRBuffer.alignment(currentAlignment, 4) + texture_resource_.length() + 1; // texture_resource_
      ...
      currentAlignment += 4 + CDRBuffer.alignment(currentAlignment, 4) + text_.length() + 1; // text_
      currentAlignment += 4 + CDRBuffer.alignment(currentAlignment, 4) + mesh_resource_.length() + 1; // mesh_resource_
