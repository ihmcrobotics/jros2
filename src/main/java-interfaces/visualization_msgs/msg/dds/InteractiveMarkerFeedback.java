 ...
 *
 * Original .msg file content (visualization_msgs/InteractiveMarkerFeedback.msg):
...
public class InteractiveMarkerFeedback implements ROS2Message<InteractiveMarkerFeedback>
{
   ...
   */
   ...
   public int calculateSizeBytes(int currentAlignment)
   {
      ...
      currentAlignment += (1 * client_id_.length()) + CDRBuffer.alignment(currentAlignment, (1 * client_id_.length())); // client_id_
      currentAlignment += (1 * marker_name_.length()) + CDRBuffer.alignment(currentAlignment, (1 * marker_name_.length())); // marker_name_
      currentAlignment += (1 * control_name_.length()) + CDRBuffer.alignment(currentAlignment, (1 * control_name_.length())); // control_name_
