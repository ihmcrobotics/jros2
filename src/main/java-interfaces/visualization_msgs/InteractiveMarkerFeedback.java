...
/**
<p>Source (visualization_msgs/InteractiveMarkerFeedback):
<pre>{@code
# Time/frame info.
...
public class InteractiveMarkerFeedback implements ROS2Message<InteractiveMarkerFeedback>
{
   ...
   */
   ...
   /**
      ...
      will be relative to the frame listed in the header.
   */
   private final geometry_msgs.Point mouse_point_;
   ...
   public InteractiveMarkerFeedback()
   {
      ...
      mouse_point_ = new geometry_msgs.Point();
   ...
   public int calculateSizeBytes(int currentAlignment)
   {
      ...
      currentAlignment += 2 + CDRBuffer.alignment(currentAlignment, 2); // event_type_
   ...
   public geometry_msgs.Point getMousePoint()
   {
      return mouse_point_;
   }
