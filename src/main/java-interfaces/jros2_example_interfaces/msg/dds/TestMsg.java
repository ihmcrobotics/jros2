...
public class TestMsg implements ROS2Message<TestMsg>
{
   ...
   public int calculateSizeBytes(int currentAlignment)
   {
      ...
      currentAlignment += 4 + CDRBuffer.alignment(currentAlignment, 4) + my_string_.length() + 1;
      ...
      currentAlignment += 4 + CDRBuffer.alignment(currentAlignment, 4) + string_of_unbounded_size_.length() + 1;
      ...
      currentAlignment += 4 + CDRBuffer.alignment(currentAlignment, 4) + full_name_.length() + 1;
