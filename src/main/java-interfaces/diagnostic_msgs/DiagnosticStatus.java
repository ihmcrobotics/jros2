...
<p>Source (diagnostic_msgs/DiagnosticStatus):
<pre>{@code
# This message holds the status of an individual component of the robot.
...
public class DiagnosticStatus implements ROS2Message<DiagnosticStatus>
{
   ...
   */
   ...
   /**
      An array of values associated with the status.
   */
   private final IDLObjectSequence<diagnostic_msgs.KeyValue> values_;
   ...
   public DiagnosticStatus()
   {
      ...
      values_ = new IDLObjectSequence<diagnostic_msgs.KeyValue>(diagnostic_msgs.KeyValue.class);
   ...
   public int calculateSizeBytes(int currentAlignment)
   {
      ...
      currentAlignment += 4 + CDRBuffer.alignment(currentAlignment, 4) + (2 * (hardware_id_.length() + 1)); // hardware_id_
