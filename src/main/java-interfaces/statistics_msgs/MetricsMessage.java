...
public class MetricsMessage implements ROS2Message<MetricsMessage>
{
   ...
   */
   ...
   public int calculateSizeBytes(int currentAlignment)
   {
      ...
      currentAlignment += 4 + CDRBuffer.alignment(currentAlignment, 4) + (2 * (measurement_source_name_.length() + 1)); // measurement_source_name_
      currentAlignment += 4 + CDRBuffer.alignment(currentAlignment, 4) + (2 * (metrics_source_.length() + 1)); // metrics_source_
      currentAlignment += 4 + CDRBuffer.alignment(currentAlignment, 4) + (2 * (unit_.length() + 1)); // unit_
