...
<p>Source (std_msgs/MultiArrayLayout):
<pre>{@code
...
public class MultiArrayLayout implements ROS2Message<MultiArrayLayout>
{
   ...
   private final IDLObjectSequence<std_msgs.MultiArrayDimension> dim_; // Array of dimension properties
   private int data_offset_; // padding bytes at front of data

   public MultiArrayLayout()
   {
      dim_ = new IDLObjectSequence<std_msgs.MultiArrayDimension>(std_msgs.MultiArrayDimension.class);
   ...
   public IDLObjectSequence<std_msgs.MultiArrayDimension> getDim()
   {
      return dim_;
   }
