...
/**
<p>Source (geometry_msgs/AccelWithCovarianceStamped):
<pre>{@code
...
public class AccelWithCovarianceStamped implements ROS2Message<AccelWithCovarianceStamped>
{
   ...
   */
   ...
   private final geometry_msgs.AccelWithCovariance accel_;

   public AccelWithCovarianceStamped()
   {
      header_ = new std_msgs.Header();
      accel_ = new geometry_msgs.AccelWithCovariance();

   }

   public AccelWithCovarianceStamped(AccelWithCovarianceStamped from)
   {
      this();
      set(from);
   }
   ...
   public geometry_msgs.AccelWithCovariance getAccel()
   {
      return accel_;
   }
