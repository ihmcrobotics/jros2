...
<p>Source (sensor_msgs/NavSatFix):
<pre>{@code
# Navigation Satellite fix for any Global Navigation Satellite System
#
# Specified using the WGS 84 reference ellipsoid
...
public class NavSatFix implements ROS2Message<NavSatFix>
{
   ...
   */
   ...
   /**
      Satellite fix status information.
   */
   private final sensor_msgs.NavSatStatus status_;
   /**
      Latitude [degrees]. Positive is north of equator; negative is south.
   */
   ...
   */
   ...
   public NavSatFix()
   {
      ...
      status_ = new sensor_msgs.NavSatStatus();
   ...
   public sensor_msgs.NavSatStatus getStatus()
   {
      return status_;
   }
