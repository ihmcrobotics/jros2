...
<p>Source (sensor_msgs/PointCloud):
<pre>{@code
...
public class PointCloud implements ROS2Message<PointCloud>
{
   ...
   */
   ...
   /**
      ...
      in the frame given in the header.
   */
   private final IDLObjectSequence<geometry_msgs.Point32> points_;
   /**
      Each channel should have the same number of elements as points array,
      and the data in each channel should correspond 1:1 with each point.
      Channel names in common practice are listed in ChannelFloat32.msg.
   */
   private final IDLObjectSequence<sensor_msgs.ChannelFloat32> channels_;

   public PointCloud()
   {
      header_ = new std_msgs.Header();
      points_ = new IDLObjectSequence<geometry_msgs.Point32>(geometry_msgs.Point32.class);
      channels_ = new IDLObjectSequence<sensor_msgs.ChannelFloat32>(sensor_msgs.ChannelFloat32.class);
   ...
   public IDLObjectSequence<geometry_msgs.Point32> getPoints()
   {
      return points_;
   }

   public IDLObjectSequence<sensor_msgs.ChannelFloat32> getChannels()
   {
      return channels_;
   }
