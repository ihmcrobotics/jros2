...
<p>Source (sensor_msgs/MultiEchoLaserScan):
<pre>{@code
# Single scan from a multi-echo planar laser range-finder
#
# If you have another ranging device with different behavior (e.g. a sonar
...
public class MultiEchoLaserScan implements ROS2Message<MultiEchoLaserScan>
{
   ...
   private final std_msgs.Header header_; // timestamp in the header is the acquisition time of
   ...
   */
   ...
   private final IDLObjectSequence<sensor_msgs.LaserEcho> ranges_; // range data [m]
   /**
      (Note: NaNs, values < range_min or > range_max should be discarded)
      +Inf measurements are out of range
      -Inf measurements are too close to determine exact distance.
   */
   private final IDLObjectSequence<sensor_msgs.LaserEcho> intensities_; // intensity data [device-specific units].  If your

   public MultiEchoLaserScan()
   {
      header_ = new std_msgs.Header();
      ranges_ = new IDLObjectSequence<sensor_msgs.LaserEcho>(sensor_msgs.LaserEcho.class);
      intensities_ = new IDLObjectSequence<sensor_msgs.LaserEcho>(sensor_msgs.LaserEcho.class);
   ...
   public IDLObjectSequence<sensor_msgs.LaserEcho> getRanges()
   {
      return ranges_;
   }

   public IDLObjectSequence<sensor_msgs.LaserEcho> getIntensities()
   {
      return intensities_;
   }
