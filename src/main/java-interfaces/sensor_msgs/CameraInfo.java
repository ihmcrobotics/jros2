...
######################################################################
<p>Source (sensor_msgs/CameraInfo):
<pre>{@code
...
public class CameraInfo implements ROS2Message<CameraInfo>
{
   ...
   */
   ...
   /**
      ...
      full resolution (roi.width = width, roi.height = height).
   */
   private final sensor_msgs.RegionOfInterest roi_;
   ...
   public CameraInfo()
   {
      ...
      r_ = new double[9];
      p_ = new double[12];
      roi_ = new sensor_msgs.RegionOfInterest();
   ...
   public int calculateSizeBytes(int currentAlignment)
   {
      ...
      currentAlignment += 4 + CDRBuffer.alignment(currentAlignment, 4) + (2 * (distortion_model_.length() + 1)); // distortion_model_
   ...
   public sensor_msgs.RegionOfInterest getRoi()
   {
      return roi_;
   }
