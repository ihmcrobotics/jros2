...
states.
<p>Source (sensor_msgs/MultiDOFJointState):
<pre>{@code
# Representation of state for joints with multiple degrees of freedom,
# following the structure of JointState which can only represent a single degree of freedom.
#
...
public class MultiDOFJointState implements ROS2Message<MultiDOFJointState>
{
   ...
   private final IDLObjectSequence<geometry_msgs.Twist> twist_;
   private final IDLObjectSequence<geometry_msgs.Wrench> wrench_;
   ...
   public MultiDOFJointState()
   {
      ...
      twist_ = new IDLObjectSequence<geometry_msgs.Twist>(geometry_msgs.Twist.class);
      wrench_ = new IDLObjectSequence<geometry_msgs.Wrench>(geometry_msgs.Wrench.class);
   ...
   public IDLObjectSequence<geometry_msgs.Twist> getTwist()
   {
      return twist_;
   }

   public IDLObjectSequence<geometry_msgs.Wrench> getWrench()
   {
      return wrench_;
   }
