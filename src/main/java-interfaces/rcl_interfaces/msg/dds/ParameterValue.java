 ...
 *
 * Original .msg file content (rcl_interfaces/ParameterValue.msg):
...
public class ParameterValue implements ROS2Message<ParameterValue>
{
   ...
   */
   ...
   public int calculateSizeBytes(int currentAlignment)
   {
      ...
      currentAlignment += (1 * string_value_.length()) + CDRBuffer.alignment(currentAlignment, (1 * string_value_.length())); // string_value_
